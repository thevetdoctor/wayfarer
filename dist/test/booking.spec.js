  ...
  _chai["default"].request(_index["default"]).post('/api/v1/auth/signin').send({
    ...
    describe('Testing Bookings Endpoints', function () {
      ...
      it('Create Booking method (POST) should book a seat on a specific trip', function (done) {
        _chai["default"].request(_index["default"]).post('/api/v1/bookings').set('Authorization', "Bearer ".concat(adminToken)).send({
          userId: 2,
          tripId: 4
        }).end(function (err, res) {
      ...
      it('Get Bookings method (GET) should return a list of bookings', function (done) {
        _chai["default"].request(_index["default"]).get('/api/v1/bookings').set('Authorization', "Bearer ".concat(adminToken)).end(function (err, res) {
          res.should.have.status(200);
          res.should.be.json;
          res.body.should.be.a('object');
          res.body.should.be.have.property('status');
      ...
      it('Delete Booking method (DELETE) should delete a specific booking', function (done) {
        _chai["default"].request(_index["default"])["delete"]('/api/v1/bookings/4').set('Authorization', "Bearer ".concat(adminToken)).end(function (err, res) {
          res.should.have.status(200);
          res.should.be.json;
          res.body.should.be.a('object');
          res.body.should.be.have.property('status');
      ...
      it('Delete Booking method (DELETE) should return an ERROR if booking is not found', function (done) {
        _chai["default"].request(_index["default"])["delete"]('/api/v1/bookings/0').set('Authorization', "Bearer ".concat(adminToken)).end(function (err, res) {
          res.should.have.status(404);
          res.should.be.json;
          res.body.should.be.a('object');
          res.body.should.be.have.property('status');
      ...
      it('Delete Booking method (DELETE) should return an ERROR if booking is found but not deleted', function (done) {
        _chai["default"].request(_index["default"])["delete"]('/api/v1/bookings/1').set('Authorization', "Bearer ".concat(adminToken)).end(function (err, res) {
          res.should.have.status(404);
          res.should.be.json;
          res.body.should.be.a('object');
          res.body.should.be.have.property('status');
